  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 w-full max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 min-h-[400px]">
        <h2 className="text-lg font-semibold text-gray-700 mb-4">Report New Incident Form</h2>
        <p className="text-gray-500">Mapped from: ecogrowth/application/views/scripts/manage-po-site/report-new-incident.phtml</p>
      </div>
    </div>
  );
};
