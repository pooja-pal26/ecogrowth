      ...
      <div className="mb-6 flex justify-between items-center">
        <div>
          ...
          <nav className="text-sm font-medium text-gray-500 mt-1 flex space-x-2">
            ...
            <span>/</span>
            <span className="text-gray-700">Invoice's Report</span>
          </nav>
        </div>
      </div>
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 min-h-[400px]">
        <h2 className="text-lg font-semibold text-gray-700 mb-4">Invoice's Report</h2>
        <div className="text-gray-500 flex items-center justify-center h-64 border-2 border-dashed border-gray-200 rounded-lg bg-gray-50">
          <p>Invoice's Report Data Table - Coming Soon</p>
        </div>
      </div>
    </div>
  );
